...
var Hook, async, tropoProvisioning, tropoSession, tropowebapi, _,
...
exports.TropoHook = (function(_super) {
  ...
  function TropoHook(options) {
    this.sendSMSEventReceived = __bind(this.sendSMSEventReceived, this);

    this.initiateSession = __bind(this.initiateSession, this);

    this.startHTTPServer = __bind(this.startHTTPServer, this);

    this.tropoRequestCallback = __bind(this.tropoRequestCallback, this);
    ...
    this.senderPhoneNumber = (_ref = options.senderPhoneNumber) != null ? _ref : 'asdf';
    this.on("hook::ready", function() {
      return _this.startHTTPServer();
    });
  }

  TropoHook.prototype.tropoRequestCallback = function(req, res, method, body) {};

  TropoHook.prototype.startHTTPServer = function() {
    var app, express,
      _this = this;
    ...
    app.post("/", function(req, res) {
      var _ref, _ref1;
      return _this.tropoRequestCallback(req, res, (_ref = req.method) != null ? _ref : "POST", (_ref1 = req.body) != null ? _ref1 : {});
    });
    return app.listen(this.port, this.hostname, function() {
      return _this.emit("tropo::webserver::started", {
        port: _this.port,
  ...
  TropoHook.prototype.sendSMSEventReceived = function(messageBody, _senderPhoneNumber, recipientPhoneNumber, callback) {
    return this.initiateSession({
      requestType: "sms",
      messageBody: messageBody,
      senderPhoneNumber: (!!_senderPhoneNumber ? _senderPhoneNumber : this.senderPhoneNumber),
